...
impl BinaryEncoder<ModifyMonitoredItemsRequest> for ModifyMonitoredItemsRequest {
    ...
    fn decode<S: Read>(stream: &mut S, decoding_options: &DecodingOptions) -> EncodingResult<Self> {
        ...
        let items_to_modify: Option<Vec<MonitoredItemModifyRequest>> = read_array(stream, decoding_options)?;
    ...
    fn type_id() -> NodeId {
        ObjectId::ModifyMonitoredItemsRequest_Encoding_DefaultBinary.into()
    }
}
