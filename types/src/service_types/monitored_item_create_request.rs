...
impl BinaryEncoder<MonitoredItemCreateRequest> for MonitoredItemCreateRequest {
    ...
    fn decode<S: Read>(stream: &mut S, decoding_options: &DecodingOptions) -> EncodingResult<Self> {
        let item_to_monitor = ReadValueId::decode(stream, decoding_options)?;
        let monitoring_mode = MonitoringMode::decode(stream, decoding_options)?;
    ...
    fn type_id() -> NodeId {
        ObjectId::MonitoredItemCreateRequest_Encoding_DefaultBinary.into()
    }
}
