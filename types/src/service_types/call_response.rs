...
use crate::{
    ...
    service_types::CallMethodResult,
};
...
impl BinaryEncoder<CallResponse> for CallResponse {
    ...
    fn decode<S: Read>(stream: &mut S, decoding_options: &DecodingOptions) -> EncodingResult<Self> {
        ...
        let results: Option<Vec<CallMethodResult>> = read_array(stream, decoding_options)?;
    ...
    fn type_id() -> NodeId {
        ObjectId::CallResponse_Encoding_DefaultBinary.into()
    }
}
